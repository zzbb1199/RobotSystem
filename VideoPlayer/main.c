...
static int fd_touch = -1; /*触摸屏文件描述符*/
 ...
 * @return int 
 */
int scroll_tackle(int delta, int flag)
{
	switch (flag)
	{
	case SCROLL_X:
 ...
 * @param count 
 */
void set_xy(int *x, int *y, int *count, struct input_event event)
{
	if (ABS_X == event.code)
	{
 ...
 * @return int 
 */
int double_click_tackle(int delta_time, int x)
{
