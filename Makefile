...
ifeq "$(CFG)" "Debug"
OUTDIR=Debug
OUTFILE=$(OUTDIR)/RobotSystem
CFG_INC=
CFG_LIB=
CFG_OBJ=
COMMON_OBJ=$(OUTDIR)/draw.o $(OUTDIR)/touch.o $(OUTDIR)/main.o \
	$(OUTDIR)/memory_share.o 
OBJ=$(COMMON_OBJ) $(CFG_OBJ)
ALL_OBJ=$(OUTDIR)/draw.o $(OUTDIR)/touch.o $(OUTDIR)/main.o \
	$(OUTDIR)/memory_share.o 
